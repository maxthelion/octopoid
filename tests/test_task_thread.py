...
class TestPostMessage:
    ...
    def test_post_creates_jsonl_file(self, tmp_path):
        ...
        with patch("octopoid.task_thread.get_threads_dir", return_value=threads_dir):
            from octopoid.task_thread import post_message, get_thread
    ...
    def test_post_appends_multiple_messages(self, tmp_path):
        ...
        with patch("octopoid.task_thread.get_threads_dir", return_value=threads_dir):
            from octopoid.task_thread import post_message
...
class TestGetThread:
    ...
    def test_get_empty_thread_for_new_task(self, tmp_path):
        ...
        with patch("octopoid.task_thread.get_threads_dir", return_value=threads_dir):
            from octopoid.task_thread import get_thread
...
class TestFormatThreadForPrompt:
    ...
    def test_empty_messages_returns_empty_string(self):
        from octopoid.task_thread import format_thread_for_prompt
...
class TestCleanupThread:
    ...
    def test_cleanup_deletes_thread_file(self, tmp_path):
        ...
        with patch("octopoid.task_thread.get_threads_dir", return_value=threads_dir):
            from octopoid.task_thread import post_message, cleanup_thread, get_thread
    ...
    def test_cleanup_nonexistent_returns_false(self, tmp_path):
        ...
        with patch("octopoid.task_thread.get_threads_dir", return_value=threads_dir):
            from octopoid.task_thread import cleanup_thread
...
class TestRejectWithFeedbackPostsMessage:
    ...
    def test_reject_with_feedback_posts_thread_message(self, tmp_path):
        ...
        with (
            patch("octopoid.task_thread.get_threads_dir", return_value=threads_dir),
            ...
            from octopoid.steps import reject_with_feedback
