"""Housekeeping jobs for the orchestrator scheduler.

This module contains all background housekeeping functions that were previously
in scheduler.py. They are logically independent of the agent spawning logic and
are invoked through a single run_housekeeping() entry point.

Public API:
    run_housekeeping  – Run all housekeeping jobs (fault-isolated)
"""
...
def debug_log(message: str) -> None:
    ...
    initialisation time (scheduler imports housekeeping; housekeeping
