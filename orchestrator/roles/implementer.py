...
1. **Create a plan document first** at `.orchestrator/agents/{self.agent_name}/plan.md`
   - Include your high-level approach
   - Break down the work into checkable steps (5-10 steps typical)
...
5. **Update your plan as you work**:
   - Check off completed steps with `[x]`
   - Add progress log entries
   - Update status.json with progress_percent based on completed steps
